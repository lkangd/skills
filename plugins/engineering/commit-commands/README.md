...
This plugin is included in the lkangd/agent-skills Code repository.
...
- Let coding agent analyze your changes and match your repo's commit style
...
- Coding agent will analyze the full branch history for the PR description
...
- **Let coding agent draft messages**: The commit message analysis learns from your repo's style
